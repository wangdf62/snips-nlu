...
from snips_nlu.constants import (
    ...
    DATA, ENTITY, ENTITY_KIND, NGRAM, TEXT, LANGUAGE)
...
class Featurizer(object):
    def __init__(self, language, unknown_words_replacement_string,
                 ...
                 custom_entity_parser=None, resources=None):
        self.config = config
    ...
    def preprocess_utterances(self, utterances):
        return [
            _preprocess_utterance(
                u, self.language, self.resources, self.builtin_entity_parser,
...
def _preprocess_utterance(utterance, language, resources,
                          builtin_entity_parser, custom_entity_parser,
                          word_clusters_name, use_stemming,
    ...
    word_clusters_features = _get_word_cluster_features(
        utterance_tokens, word_clusters_name, resources)
    normalized_stemmed_tokens = [
        _normalize_stem(t, language, resources, use_stemming)
    ...
    filtered_normalized_stemmed_tokens = [
        _normalize_stem(chunk[TEXT], language, resources, use_stemming)
